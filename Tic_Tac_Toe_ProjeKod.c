...
int main()
{
  printf("*********TicTacToe Oyununa Hosgeldiniz Iyi Oyunlar********* \n\n");
   ...
   printf("1.Oyuncu Adi Soyadi:");
	...
	fptr= fopen("C:\\Users\\mahmu\\OneDrive\\Desktop\\bilgi.txt","w");
	...
	fprintf(fptr,"1.Oyuncu Adi: %s\n",oyuncu.isim1);
	fprintf(fptr,"1.Oyuncu Yasi: %d\n\n",oyuncu.yas1);
	fprintf(fptr,"2.Oyuncu Adi: %s\n",oyuncu.isim2);
	fprintf(fptr,"2.Oyuncu Yasi: %d",oyuncu.yas2);
